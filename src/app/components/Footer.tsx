      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul role="list" className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/equipe" className="text-base text-gray-500 hover:text-gray-900">
                  Equipe
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul role="list" className="mt-4 space-y-4">
              <li>
                <Link href="/cursos" className="text-base text-gray-500 hover:text-gray-900">
                  Cursos
                </Link>
              </li>
              <li>
                <Link href="/planos" className="text-base text-gray-500 hover:text-gray-900">
                  Planos
                </Link>
              </li>
              <li>
                <Link href="/certificacoes" className="text-base text-gray-500 hover:text-gray-900">
                  Certificações
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul role="list" className="mt-4 space-y-4">
              <li>
                <Link href="/ajuda" className="text-base text-gray-500 hover:text-gray-900">
                  Central de Ajuda
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; {new Date().getFullYear()} EducaMaster AI. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
