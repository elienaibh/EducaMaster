...
// Registra o service worker quando o aplicativo inicia
                                                ...
                                                <div className="flex flex-col min-h-screen">
                                                    ...
                                                    <main className="flex-grow">
                                                        <Routes>
                                                            ...
                                                            {/* Rota pública para conteúdo compartilhado */}
                                                            <Route path="/share/:contentType/:shareId" element={<SharedContentPage />} />
